    ...
    <table class="table" id="authors-table">
        ...
        <?php foreach ($authors as $author): ?>
            <tr>
                ...
                <td><?= $author->name; ?></td>
                <td>
                    <a href="/web/v1/author/<?= $author->id; ?>" class="edit">Редактировать</a>
...
<div class="row">
    ...
    <table class="table" id="books-table">
        ...
        <?php foreach ($books as $book): ?>
            <tr>
                ...
                <td><?= $book->cover; ?></td>
                <td>
                    <a href="/web/v1/book/<?= $book->id; ?>" class="edit">Редактировать</a>
    ...
    <form id="book-form" role="form" method="post" action="/web/v1/book" class="form-inline">
        ...
        <div class="form-group">
            <input type="text" name="ApiBook[cover]" class="form-control" placeholder="Обложка">
        </div>
